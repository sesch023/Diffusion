...
class Encoder(nn.Module):
    # Adapted from:
    # https://github.com/CompVis/taming-transformers/blob/master/taming/modules/diffusionmodules/model.py#L342
    def __init__(self, 
            ch,
            in_channels,
            resolution, 
...
class NLayerDiscriminator(nn.Module):
    ...
    def __init__(self, input_nc=3, ndf=64, n_layers=3):
        ...
        Parameters:
            ...
            ndf (int)       -- the number of filters in the last (Kommentar: first??) conv layer

...
class ResBlock(nn.Module):
    def __init__(self, in_channels, out_channels, sample_mode=ResBlockSampleMode.IDENTITY, emb_size=1024, dropout=0.1, skip_con=True, use_scale_shift_norm=True):
        super().__init__()
...
class SelfAttention(nn.Module):
    ...
    https://github.com/epfml/text_to_image_generation/blob/main/guided_diffusion/unet.py#L361
    """
    def __init__(self, channels, mha_heads=4, mha_head_channels=None, torch_mha=False):
        super().__init__()
...
class SelfAttentionResBlock(ResBlock):
    def __init__(self, in_channels, out_channels, mha_heads=4, mha_head_channels=None, emb_size=1024, dropout=0.1, skip_con=True):
        super().__init__(in_channels, out_channels, ResBlockSampleMode.IDENTITY, emb_size, dropout, skip_con)
